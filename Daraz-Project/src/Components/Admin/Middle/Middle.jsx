...
const Middle = () => {
  return (
    <div className="bg-slate-200">
      <div className="flex flex-col lg:flex-row justify-around items-start my-2">
        <div className="p-5 flex justify-start items-center bg-white w-full lg:w-2/5 rounded-md gap-5 mb-4 lg:mb-0">
          <div>
            <img
              className="image-card-img image-mode-scaleToFill w-16 h-16 object-cover rounded"
        ...
        <div className="bg-white px-5 py-2 flex flex-col justify-start items-center w-full lg:w-2/5 rounded-md gap-5">
          ...
          <div className="flex justify-center items-center gap-5 w-full">
            <div className="h-20 w-20">
              <img
                className="image-card-img image-mode-scaleToFill w-full h-full object-cover rounded-full"
      ...
      <div>
        <div>
          <div className=" rounded-xl mx-8 bg-gradient-to-b from-orange-600 to-white h-full my-2">
            <div>
              <h1 className="font-bold mx-10 pt-10 pb-5 text-2xl text-white">
                To Do
              </h1>
            </div>
            ...
            <div className="flex flex-col justify-center gap-3 items-center bg-white m-10 p-10 rounded-lg">
              ...
              <div>
                <h1 className="font-bold text-xl">Add pick-up</h1>
              </div>
              ...
              <div className="w-1/4">
                <button className="text-white bg-orange-500 w-full py-1 rounded-xl font-semibold">
                  Add
                </button>
              </div>
              <div className="hidden md:block">
      ...
      <div>
        <div className="mx-8 my-2 sm:my-0  bg-white rounded-xl px-4 py-6 sm:px-0 sm:py-0 flex flex-col items-center justify-center">
          <h1 className="font-bold text-2xl sm:text:lg">DARAZ UNIVERSITY</h1>
